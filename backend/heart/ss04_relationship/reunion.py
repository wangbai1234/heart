...
class ReunionStateMachine:
    ...
    def __init__(self, soul_config: Optional[Dict[str, Any]] = None):
        ...
        self.reunion_modifiers = relational_template.get("reunion_modifiers", {
    ...
    def advance_reunion(
        ...
        if current_phase == "initial":
            ...
            strong_engagement = (
                user_engagement_signals.get("vulnerability_disclosed", False) or
                user_engagement_signals.get("absence_explained", False)
            )
    ...
    def compute_trust_decay_during_absence(
        ...
        stage_order = ["STRANGER", "ACQUAINTANCE", "FRIEND", "CONFIDANT",
