...
class ColdWarTracker:
    ...
    def __init__(self, soul_config: Optional[Dict[str, Any]] = None):
        ...
        self.cold_war_modifiers = relational_template.get("cold_war_modifiers", {
    ...
    def _resolve_cold_war(
        ...
        relationship_state["total_successful_repairs"] = relationship_state.get("total_successful_repairs", 0) + 1
