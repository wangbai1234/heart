...
class SignalAggregator:
    ...
    def aggregate(
        ...
        for sig in all_signals:
            ...
            if sig.type.startswith("neg_") or sig.type in {
                ...
                "consistent_presence_milestone",
                "sacred_disclosure_acknowledged",
                "memory_recall_confirmed",
                "repair_completed",
                "user_remembers_detail",
                "shared_vulnerability",
                "anniversary_acknowledged",
                "successful_repair",
    ...
    def get_cooldown_violations(self, signal_types: list[str]) -> int:
        ...
        return self.cooldown_tracker.count_violations(self.user_id, self.character_id, signal_types)
