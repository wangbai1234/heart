"""
DeepSeek V4-pro provider implementation.

Note: Named 'anthropic.py' but implements DeepSeek V4-pro (deepseek-reasoner)
...
class DeepSeekV4ProProvider(LLMProvider):
    """
    DeepSeek V4-pro (deepseek-reasoner) provider.

    High-quality model for main responses with reasoning capability.
    ...
    def __init__(
        ...
        """
        Initialize DeepSeek V4-pro provider.
    ...
    async def call(self, request: LLMRequest) -> LLMResponse:
        """
        Non-streaming call to DeepSeek V4-pro.
    ...
    def estimate_cost(
        ...
        """
        Estimate cost for DeepSeek V4-pro call.
        ...
        Returns:
            Cost estimate
        """
        pricing = self.PRICING.get(model, self.PRICING["deepseek-reasoner"])
