...
class TTSRequest:
    ...
    # .clone_audio_url — a local path, http(s) URL, or s3://<key> read with
    # backend credentials). When set, the MiMo provider switches to the
    # voiceclone model and speaks in the referenced timbre.
