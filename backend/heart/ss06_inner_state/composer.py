...
class InnerStateComposer:
    ...
    def compose(
        ...
        *,
        ...
        # ── Since-last-talk ──
        since_seconds, since_label = self._compute_since_last_talk(
    ...
    def _compute_since_last_talk(
        self, last_interaction_at: Optional[str]
    ) -> tuple[float, str]:
        ...
        try:
            last_dt = datetime.fromisoformat(
                last_interaction_at.replace("Z", "+00:00")
            )
