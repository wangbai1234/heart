...
class AntiDriftInjector:
    ...
    def _build_reinforce_layer(self, drift_evidence: Optional[DriftEvidence] = None) -> PromptLayer:
        ...
        soul = injector._registry.get_soul(
            ...
            list(injector._registry.list_versions(list(injector._registry.list_characters())[0]))[
                0
            ],
        )
