...
class TestHotPathAllServicesInvoked:
    ...
    async def test_all_services_invoked_on_compose(self):
        ...
        emotion_svc.get_context_block = AsyncMock(
            return_value={
                "emotion_summary": "平静",
        ...
        relationship_svc.get_current_phase = AsyncMock(
            return_value={
                "phase": "stranger",
                "trust_level": 0.0,
                "attachment_style": "",
...
class TestHotPathDegradation:
    ...
    async def test_subsystem_failure_degrades_but_returns_200(self, attr_name, reason_key):
        ...
        good_emotion.get_context_block = AsyncMock(
            return_value={
                "emotion_summary": "平静",
                "vad": {"valence": 0.0, "arousal": 0.3, "dominance": 0.5},
                "active_emotions": [],
        ...
        good_relationship.get_current_phase = AsyncMock(
            return_value={
                "phase": "stranger",
                "trust_level": 0.0,
                "attachment_style": "",
        ...
        failing_relationship.get_current_phase = AsyncMock(
            side_effect=RuntimeError("stage engine crash")
        )
