...
const BESPOKE_PROFILES: Record<string, ComponentType<{ profile: CharacterProfileDTO }>> = {
  ...
  wen_li: WenLiProfile,
  chu_hansheng: ChuHanshengProfile,
  lu_shijin: LuShijinProfile,
  pei_jixing: PeiJixingProfile,
  xiao_bochen: XiaoBochenProfile,
  gu_yanshen: GuYanshenProfile,
  song_shiqi: SongShiqiProfile,
  fu_chengyan: FuChengyanProfile,
  ji_yan: JiYanProfile,
  huo_qingyin: HuoQingyinProfile,
  chen_muye: ChenMuyeProfile,
  shen_zhixu: ShenZhixuProfile,
  xie_linyuan: XieLinyuanProfile,
  xiao_lin: XiaoLinProfile,
  jiang_yimo: JiangYimoProfile,
  shen_yueqing: ShenYueqingProfile,
  ling_xiao: LingXiaoProfile,
  ye_xiuyuan: YeXiuyuanProfile,
  xie_changan: XieChanganProfile,
}
...
const CHROME_PALETTES: Record<string, ChromePalette> = {
  ...
  wen_li: { bg:'#0d0b10',coverBg:'#1a161e',scrimGradient:'linear-gradient(to top,#0d0b10 6%,rgba(13,11,16,.4) 40%,transparent)',nameColor:'#f0e6dc',ageColor:'#b5a898',taglineColor:'#d4a090',chipActiveBg:'rgba(196,68,68,.1)',chipActiveBorder:'rgba(196,68,68,.3)',chipActiveText:'#d4a090',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#b5a898',ctaGradient:'linear-gradient(105deg,#8b3a3a,#6b2a2a)',ctaShadow:'0 10px 26px rgba(139,58,58,.35)' },
  chu_hansheng: { bg:'#141e28',coverBg:'#1e2a34',scrimGradient:'linear-gradient(to top,#141e28 6%,rgba(20,30,40,.4) 40%,transparent)',nameColor:'#e8e2d8',ageColor:'#9aafbb',taglineColor:'#d4c8b4',chipActiveBg:'rgba(139,115,85,.1)',chipActiveBorder:'rgba(139,115,85,.3)',chipActiveText:'#d4c8b4',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#9aafbb',ctaGradient:'linear-gradient(105deg,#4a6070,#2c3e50)',ctaShadow:'0 10px 26px rgba(74,96,112,.35)' },
  lu_shijin: { bg:'#0d1018',coverBg:'#161e28',scrimGradient:'linear-gradient(to top,#0d1018 6%,rgba(13,16,24,.4) 40%,transparent)',nameColor:'#e0e8f0',ageColor:'#6a7a8a',taglineColor:'#a0b0c8',chipActiveBg:'rgba(138,154,176,.1)',chipActiveBorder:'rgba(138,154,176,.3)',chipActiveText:'#a0b0c8',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#6a7a8a',ctaGradient:'linear-gradient(105deg,#8a9ab0,#4a5a70)',ctaShadow:'0 10px 26px rgba(138,154,176,.35)' },
  pei_jixing: { bg:'#1a1410',coverBg:'#2a2218',scrimGradient:'linear-gradient(to top,#1a1410 6%,rgba(26,20,16,.4) 40%,transparent)',nameColor:'#f0e6dc',ageColor:'#a08878',taglineColor:'#d86060',chipActiveBg:'rgba(196,68,68,.1)',chipActiveBorder:'rgba(196,68,68,.3)',chipActiveText:'#d86060',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#a08878',ctaGradient:'linear-gradient(105deg,#c44444,#8a7060)',ctaShadow:'0 10px 26px rgba(196,68,68,.35)' },
  xiao_bochen: { bg:'#1a1a2e',coverBg:'#242438',scrimGradient:'linear-gradient(to top,#1a1a2e 6%,rgba(26,26,46,.4) 40%,transparent)',nameColor:'#e8e4e0',ageColor:'#8a8aa0',taglineColor:'#d0c8c0',chipActiveBg:'rgba(200,192,184,.1)',chipActiveBorder:'rgba(200,192,184,.3)',chipActiveText:'#d0c8c0',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#8a8aa0',ctaGradient:'linear-gradient(105deg,#c8c0b8,#6a9ab0)',ctaShadow:'0 10px 26px rgba(200,192,184,.35)' },
  gu_yanshen: { bg:'#0a0a0a',coverBg:'#141414',scrimGradient:'linear-gradient(to top,#0a0a0a 6%,rgba(10,10,10,.4) 40%,transparent)',nameColor:'#e0c0c0',ageColor:'#6a4040',taglineColor:'#c04040',chipActiveBg:'rgba(139,26,26,.12)',chipActiveBorder:'rgba(139,26,26,.34)',chipActiveText:'#c04040',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#6a4040',ctaGradient:'linear-gradient(105deg,#8b1a1a,#4a2020)',ctaShadow:'0 10px 26px rgba(139,26,26,.38)' },
  song_shiqi: { bg:'#1a1410',coverBg:'#2a2218',scrimGradient:'linear-gradient(to top,#1a1410 6%,rgba(26,20,16,.4) 40%,transparent)',nameColor:'#f0e6dc',ageColor:'#a08878',taglineColor:'#e8c8c0',chipActiveBg:'rgba(192,128,128,.1)',chipActiveBorder:'rgba(192,128,128,.3)',chipActiveText:'#e8c8c0',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#a08878',ctaGradient:'linear-gradient(105deg,#e8c8c0,#c08080)',ctaShadow:'0 10px 26px rgba(232,200,192,.35)' },
  fu_chengyan: { bg:'#1a0d10',coverBg:'#2a1a1e',scrimGradient:'linear-gradient(to top,#1a0d10 6%,rgba(26,13,16,.4) 40%,transparent)',nameColor:'#f0e6dc',ageColor:'#a06070',taglineColor:'#d4a858',chipActiveBg:'rgba(201,168,76,.1)',chipActiveBorder:'rgba(201,168,76,.3)',chipActiveText:'#d4a858',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#a06070',ctaGradient:'linear-gradient(105deg,#c9a84c,#8a3040)',ctaShadow:'0 10px 26px rgba(201,168,76,.35)' },
  ji_yan: { bg:'#1c1c1e',coverBg:'#28282a',scrimGradient:'linear-gradient(to top,#1c1c1e 6%,rgba(28,28,30,.4) 40%,transparent)',nameColor:'#e0e0e4',ageColor:'#8e8e93',taglineColor:'#c8c8cc',chipActiveBg:'rgba(192,192,192,.1)',chipActiveBorder:'rgba(192,192,192,.3)',chipActiveText:'#c8c8cc',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#8e8e93',ctaGradient:'linear-gradient(105deg,#c0c0c0,#606068)',ctaShadow:'0 10px 26px rgba(192,192,192,.35)' },
  huo_qingyin: { bg:'#141210',coverBg:'#201e1a',scrimGradient:'linear-gradient(to top,#141210 6%,rgba(20,18,16,.4) 40%,transparent)',nameColor:'#f0e8dc',ageColor:'#8a7e68',taglineColor:'#e8dcc8',chipActiveBg:'rgba(196,74,32,.1)',chipActiveBorder:'rgba(196,74,32,.3)',chipActiveText:'#e8a060',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#8a7e68',ctaGradient:'linear-gradient(105deg,#e8dcc8,#c44a20)',ctaShadow:'0 10px 26px rgba(232,220,200,.35)' },
  chen_muye: { bg:'#101010',coverBg:'#1c1c1c',scrimGradient:'linear-gradient(to top,#101010 6%,rgba(16,16,16,.4) 40%,transparent)',nameColor:'#e8e0d4',ageColor:'#8a8a8a',taglineColor:'#d0a860',chipActiveBg:'rgba(200,160,80,.1)',chipActiveBorder:'rgba(200,160,80,.3)',chipActiveText:'#d0a860',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#8a8a8a',ctaGradient:'linear-gradient(105deg,#c8a050,#6a6a6a)',ctaShadow:'0 10px 26px rgba(200,160,80,.35)' },
  shen_zhixu: { bg:'#0d1014',coverBg:'#181c22',scrimGradient:'linear-gradient(to top,#0d1014 6%,rgba(13,16,20,.4) 40%,transparent)',nameColor:'#e0e8f0',ageColor:'#5a6a78',taglineColor:'#c8d0d8',chipActiveBg:'rgba(106,138,152,.1)',chipActiveBorder:'rgba(106,138,152,.3)',chipActiveText:'#a0b8c8',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#5a6a78',ctaGradient:'linear-gradient(105deg,#c8d0d8,#3a3a40)',ctaShadow:'0 10px 26px rgba(200,208,216,.35)' },
  xie_linyuan: { bg:'#141008',coverBg:'#201c14',scrimGradient:'linear-gradient(to top,#141008 6%,rgba(20,16,8,.4) 40%,transparent)',nameColor:'#f0e8dc',ageColor:'#8a7858',taglineColor:'#e8a0a0',chipActiveBg:'rgba(232,160,160,.1)',chipActiveBorder:'rgba(232,160,160,.3)',chipActiveText:'#e8a0a0',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#8a7858',ctaGradient:'linear-gradient(105deg,#e8a0a0,#d8c8a8)',ctaShadow:'0 10px 26px rgba(232,160,160,.35)' },
  xiao_lin: { bg:'#0d1117',coverBg:'#181e26',scrimGradient:'linear-gradient(to top,#0d1117 6%,rgba(13,17,23,.4) 40%,transparent)',nameColor:'#e0d8c8',ageColor:'#6a7a8a',taglineColor:'#d0a858',chipActiveBg:'rgba(201,168,76,.1)',chipActiveBorder:'rgba(201,168,76,.3)',chipActiveText:'#d0a858',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#6a7a8a',ctaGradient:'linear-gradient(105deg,#c9a84c,#4a5060)',ctaShadow:'0 10px 26px rgba(201,168,76,.35)' },
  jiang_yimo: { bg:'#1a1410',coverBg:'#2a2218',scrimGradient:'linear-gradient(to top,#1a1410 6%,rgba(26,20,16,.4) 40%,transparent)',nameColor:'#f0e8dc',ageColor:'#8a7a68',taglineColor:'#e8a060',chipActiveBg:'rgba(232,160,96,.1)',chipActiveBorder:'rgba(232,160,96,.3)',chipActiveText:'#e8a060',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#8a7a68',ctaGradient:'linear-gradient(105deg,#e8a060,#4060a0)',ctaShadow:'0 10px 26px rgba(232,160,96,.35)' },
  shen_yueqing: { bg:'#141810',coverBg:'#202818',scrimGradient:'linear-gradient(to top,#141810 6%,rgba(20,24,16,.4) 40%,transparent)',nameColor:'#e0e8dc',ageColor:'#7a8a78',taglineColor:'#8ab8c8',chipActiveBg:'rgba(106,154,176,.1)',chipActiveBorder:'rgba(106,154,176,.3)',chipActiveText:'#8ab8c8',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#7a8a78',ctaGradient:'linear-gradient(105deg,#6a9ab0,#8a7060)',ctaShadow:'0 10px 26px rgba(106,154,176,.35)' },
  ling_xiao: { bg:'#1a1408',coverBg:'#282010',scrimGradient:'linear-gradient(to top,#1a1408 6%,rgba(26,20,8,.4) 40%,transparent)',nameColor:'#f0e8d4',ageColor:'#8a7240',taglineColor:'#d4b060',chipActiveBg:'rgba(201,168,76,.12)',chipActiveBorder:'rgba(201,168,76,.34)',chipActiveText:'#d4b060',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#8a7240',ctaGradient:'linear-gradient(105deg,#c9a84c,#4a2860)',ctaShadow:'0 10px 26px rgba(201,168,76,.35)' },
  ye_xiuyuan: { bg:'#141810',coverBg:'#202818',scrimGradient:'linear-gradient(to top,#141810 6%,rgba(20,24,16,.4) 40%,transparent)',nameColor:'#e0e8dc',ageColor:'#6a7a60',taglineColor:'#d4c8a8',chipActiveBg:'rgba(106,122,96,.1)',chipActiveBorder:'rgba(106,122,96,.3)',chipActiveText:'#c4d0b0',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#6a7a60',ctaGradient:'linear-gradient(105deg,#d4c8a8,#4a5a40)',ctaShadow:'0 10px 26px rgba(212,200,168,.35)' },
  xie_changan: { bg:'#0d1410',coverBg:'#1a2218',scrimGradient:'linear-gradient(to top,#0d1410 6%,rgba(13,20,16,.4) 40%,transparent)',nameColor:'#e0e8dc',ageColor:'#6a8a68',taglineColor:'#e8c878',chipActiveBg:'rgba(232,200,120,.1)',chipActiveBorder:'rgba(232,200,120,.3)',chipActiveText:'#e8c878',chipInactiveBg:'rgba(255,255,255,.05)',chipInactiveBorder:'rgba(255,255,255,.1)',chipInactiveText:'#6a8a68',ctaGradient:'linear-gradient(105deg,#e8c878,#4a6848)',ctaShadow:'0 10px 26px rgba(232,200,120,.35)' },
}
