    ...
    <div className="relative isolate h-full overflow-hidden bg-[#FFF9F5]">
      ...
      >
            ...
            {steps.map((step) => (
              ...
              >
                ...
                <div className="relative -mt-16 px-6 text-center">
                  <h1 className="whitespace-pre-line text-[24px] font-semibold leading-[1.38] tracking-[-0.03em] text-[#2E3348]">
                    {step.title}
                  </h1>
                  <p className="mx-auto mt-4 max-w-[286px] text-[16px] leading-[1.72] tracking-[-0.01em] text-[rgba(61,69,96,0.62)]">
                    {step.description}
                  </p>
                </div>
              </section>
        ...
        <div
          ...
          style={{ paddingBottom: 'calc(4px + var(--safe-bottom))', transform: `translateY(${currentStep < 2 ? '-96px' : '-64px'})` }}
        >
