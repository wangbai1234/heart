...
const characters: Character[] = [
  {
    ...
    glowColor: 'rgba(200,182,255,0.5)',
  },
  {
    id: 'taolesi',
    name: '桃乐丝',
    ...
    glowColor: 'rgba(167,199,231,0.5)',
  },
]
...
export function CharacterPage() {
  ...
  const [selected, setSelected] = useState('rin')
  ...
  const handleConfirm = () => {
    setCharacter(selected as 'rin' | 'taolesi')
    ...
    <div className="relative w-full h-full flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex-1 overflow-y-auto">
        ...
        <div className="relative h-[300px] shrink-0">
          <img src="/assets/backgrounds/background_character_hero.webp" alt="" className="w-full h-full object-cover" />
          <div className="absolute bottom-0 left-0 right-0 h-[60px] bg-gradient-to-t from-[var(--color-surface)] to-transparent" />
        </div>

        {/* Character Cards */}
        <div className="relative px-4 -mt-6 flex flex-col gap-3 pb-[100px]">
          {characters.map((char) => {
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div className="relative shrink-0">
                    <div
                      ...
                      style={{ background: `linear-gradient(135deg, ${char.glowColor}, transparent)` }}
                    >
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-center">
                    ...
                    <p className="text-[13px] text-[var(--color-text-secondary)]">
                      {char.id === 'rin' ? '温柔倾听 · 共情型' : '话痨同好 · 元气满满'}
                    </p>
                  </div>
                </div>
                ...
                <div className="absolute top-5 right-5">
                  {isSelected ? (
                    ...
                    <div className="px-4 py-2 rounded-[18px] border-[1.5px] border-[var(--color-primary)] bg-transparent">
                      <span className="text-[14px] font-medium text-[var(--color-primary)]">选择</span>
                    </div>
                  )}
                </div>
              </button>
