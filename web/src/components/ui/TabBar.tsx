      ...
      <div className="flex items-end px-2">
        ...
        <div className="flex-1 flex flex-col items-center">
          <button
            ...
            aria-label="创作"
            className="-mt-[22px] w-[56px] h-[56px] rounded-full flex items-center justify-center bg-[var(--color-primary)] shadow-[0_6px_20px_-4px_rgba(255,143,171,0.32),inset_0_1px_2px_rgba(255,255,255,0.25)] before:absolute before:inset-[-3px] before:rounded-full before:bg-[var(--color-glass-90)] before:z-[-1] active:scale-95 hover:shadow-[0_8px_24px_-4px_rgba(255,143,171,0.40),inset_0_1px_2px_rgba(255,255,255,0.30)] hover:brightness-105 transition-all duration-[var(--duration-normal)] ease-[var(--ease-standard)]"
          >
          ...
          <span className={`mt-[3px] text-[11px] transition-all duration-[var(--duration-fast)] ${createActive ? 'text-[var(--color-tab-active)] font-medium' : 'text-[var(--color-tab-inactive)]'}`}>
            创作
          </span>
        </div>
